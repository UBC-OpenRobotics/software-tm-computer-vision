...
def main():
    ...
    # Handle tokens_positive specifically
    tokens_positive = call_args.pop('tokens_positive', None)
    if tokens_positive is not None:
        # Set this directly on the model if it's a Grounding DINO model
        if hasattr(inferencer.model, 'set_tokens_positive'):
            inferencer.model.set_tokens_positive(tokens_positive)
        else:
            print_log("Warning: Model doesn't support tokens_positive parameter. Ignoring it.")
